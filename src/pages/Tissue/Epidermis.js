...
เป็นเนื้อเยื่อถาวรเชิงเดี่ยว กำเนิดมาจากชั้น Protoderm มักเรียกกันว่า เนื้อเยื่อผิว เมื่อมีการเจริญขั้นที่สอง (secondary growth) เนื้อเยื่อ Epidermis จะสลายไป เพราะมีชั้นของ [Cork](#/tissue/cork) ที่เกิดขึ้นใต้ Epidermis เจริญดันออกมา
...
ช่วยป้องกันอันตรายให้แก่เนื้อเยื่อที่อยู่ภายใน และเสริมความแข็งแรง ช่วยป้องกันการระเหยและการคายน้ำ เกี่ยวกับการคายน้ำแลกเปลี่ยนแก๊ส สะสมน้ำและสารที่ได้จาก Metabolism เกี่ยวกับการสังเคราะห์แสง การขับของเสียหรือสร้างเซลล์ใหม่ปกคลุมเมื่อมีบาดแผล ช่วยดูดซึมน้ำและแร่ธาตุ โดยเฉพาะอย่างยิ่งทางขนราก
`
